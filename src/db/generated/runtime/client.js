    ...
    Zi.exports = (function () {
        ...
        return function (t, r) {
            ...
            var a = 0,
                ...
                j = [];
            for (l = 0; l < i; l++)
                (j.push(l + 1), j.push(t.charCodeAt(s + l)));
...
function Qe(e = {}) {
    ...
    return Object.entries(t).reduce(
        (n, [i, o]) => (
            Do[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
            n
        ),
        { select: {} },
    );
...
function An(e) {
    throw wr(e)
        ? new I(
              `Raw query failed. Code: \`${e.cause.originalCode ?? 'N/A'}\`. Message: \`${e.cause.originalMessage ?? us(e)}\``,
              'P2010',
...
function vn(e, t, r, n) {
    switch (r.type) {
        ...
        case 'datetime': {
            if (typeof e == 'string')
                return { $type: 'DateTime', value: Ep(e) };
        ...
        case 'bytes': {
            switch (r.encoding) {
                ...
                case 'hex':
                    ...
                    return {
                        $type: 'Bytes',
                        value: Buffer.from(e.slice(2), 'hex').toString(
                            'base64',
                        ),
                    };
                case 'array':
